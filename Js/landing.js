...
let listOfFiles = {
	...
	'About_Me.txt': () => {
		historyCommands += "Hi I'm Spandan, a part time ethical hacker.<br><br>";
	},
	'Contact_Me.txt': () => {
		historyCommands +=
		"HackerOne: <a href = 'https://hackerone.com/spandan_pokh?type=user' target='_blank'>Spandan_pokh</a><br>Facebook: 	<a href = 'https://facebook.com/spandanpokh' target='_blank'>Spandanpokh</a><br>BugCrowd: 	<a href = 'https://bugcrowd.com/Spandan_pokh' target='_blank'>Spandanp_okh</a><br><br>";
	},
	'Github.txt': () => {
		historyCommands +=
			"GitHub: <a href = 'https://github.com/spandanpokh' target='_blank'>Spandanpokh</a><br><br>";
	},
	'Linkedin.txt': () => {
		historyCommands +=
	...
	'Credits.txt': () => {
		historyCommands +=
			"Complete credit goes to R Narayan @bitoffabyte. <br><br>";
	},
};
